const app = new PIXI.Application({width:5000,height:5000, backgroundColor: 0x103322 });
...
const container2 = new PIXI.projection.Container2d();
...
const bunny = new PIXI.projection.Sprite2d(PIXI.Texture.from('assets/wheel_ref.png'));
bunny.anchor.set(0.5);
bunny.scale.set(1);
container2.addChild(bunny);
bunny.position.set(1200,1000);
...
function onDragEnd(event) {
    ...
    const posX = container.toLocal(squareX.position, undefined, undefined, undefined, PIXI.projection.TRANSFORM_STEP.BEFORE_PROJ);
    const posY = container.toLocal(squareY.position, undefined, undefined, undefined, PIXI.projection.TRANSFORM_STEP.BEFORE_PROJ);
    console.log("AxisX bilgiler:"+ " x:"+posX.x, " y:"+posX.y + " factor:"+squareX.factor);
    console.log("AxisY bilgiler:"+ " x:"+posY.x, " y:"+posY.y + " factor:"+squareY.factor);
